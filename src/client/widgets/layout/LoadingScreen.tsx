...
const StarIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="#D9913B" className="inline-block -translate-y-1 transform">
...
export function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => {
      ...
      if (current >= 100) {
        ...
        window.setTimeout(() => setIsFadingOut(true), 400)
      }
    }, 40)
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[100] flex h-[100dvh] w-[100vw] flex-col items-center justify-center transition-opacity duration-500 ease-in-out ${
      ...
      >
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-6 px-6">
          <div className="flex flex-col items-center text-center">
            <h1 className="flex items-center gap-3 font-manual text-5xl font-semibold tracking-tight text-cafe">
              <StarIcon />
              Cantinho da Vovó
              <StarIcon />
            </h1>
            <p className="mt-1 font-manual text-xl italic text-tomate">preparando seu pedido com carinho...</p>
          </div>

          <div className="w-full max-w-[500px]" style={{ width: 'min(500px, 90vw)' }}>
            <svg viewBox="0 0 500 350" className="h-auto w-full drop-shadow-sm" strokeLinejoin="round" strokeLinecap="round">
              ...
              <g className="origin-bottom animate-moto-ride">
                ...
                <text x="184" y="60" fill="#4A2E24" fontSize="10" fontFamily="monospace" fontWeight="600" stroke="none">
                  CVV
                </text>
          ...
          <div className="mt-4 flex w-full flex-col items-center gap-2" style={{ width: 'min(420px, 80vw)' }}>
            <div className="flex w-full justify-end">
              <span className="font-mono text-sm font-semibold tracking-tight text-cafe">{Math.round(progress)}%</span>
            </div>

            <div className="h-[10px] w-full overflow-hidden rounded-full bg-creme-manteiga" style={{ border: '1px solid rgba(74,46,36,0.12)' }}>
              <div
            ...
            <div className="mt-2 flex h-8 items-center justify-center">
              <span key={msgIndex} className="animate-msg-fade text-center font-manual text-lg text-cafe/50">
                {messages[msgIndex]}
              </span>
            </div>
          </div>
