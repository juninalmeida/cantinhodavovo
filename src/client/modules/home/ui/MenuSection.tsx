...
export function MenuSection({ products, loading, isExpanded, onOpen, onMinimize, errorMessage }: MenuSectionProps) {
  ...
  return (
    <section id="cardapio" className="relative mx-auto max-w-7xl scroll-mt-28 px-6 py-20">
      ...
      {!isExpanded ? (
        ...
        <div className="rounded-2xl border-2 border-tomate/20 bg-white p-8 text-center text-tomate">{errorMessage}</div>
      ) : (
