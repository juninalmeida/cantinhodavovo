  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <Panel>
        ...
        {createdTrackingCode && (
          <div className="mt-4 rounded-2xl border-2 border-cafe/10 bg-creme-manteiga/40 p-4 text-sm text-cafe/75">
            Código de acompanhamento gerado: <strong>{createdTrackingCode}</strong>
          </div>
        )}
