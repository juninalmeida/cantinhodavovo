...
import { ComboOrderTicket } from '../brand/ComboOrderTicket'
import { HeroSection } from '../brand/HeroSection'
import { Icon } from '../brand/icons/Icon'
import { MenuSection } from '../brand/MenuSection'
import { decorateComboOption } from '../brand/comboVisuals'
...
export function HomePage() {
  ...
  useEffect(() => {
    ...
    async function loadHomeData() {
      ...
      setComboOptions(comboResponse.comboOptions.map(decorateComboOption))
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (user) {
        ...
        window.location.href = `/acompanhar/${order.trackingCode}`
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      <section id="pedido" ref={comboSectionRef} className="bg-caderno-receita relative border-y-2 border-cafe py-20">
